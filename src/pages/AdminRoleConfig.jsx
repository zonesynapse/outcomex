...
export default function AdminRoleConfig() {
  ...
  const ALL_PAGES = [
    ...
    { id: "activity-settings-config", label: "Activity Settings & Custom Fields", path: "/activity-settings", module: "Configuration" },
    ...
    { id: "activity-settings", label: "Activity — Dynamic Settings", path: "/activity-settings", module: "Activity" },
