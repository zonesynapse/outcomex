...
// Fetch all appraisal records (Teaching, Non-Teaching, HOD, Teacher)
  ...
  const handleReviewAction = async (newStatus) => {
    ...
    try {
      const targetColl = selectedAppraisal.formType === "hod" ? "hod_appraisals" : selectedAppraisal.formType === "non_teaching" ? "non_teaching_appraisals" : selectedAppraisal.formType === "teacher" ? "teacher_appraisals" : "faculty_appraisals";
